<template>
  <div class="collection-container">
    ...
    <div class="row mb-3">
      <div class="col">
        <b-button-group>
          ...
          <b-button
            :variant="filter === 'collected' ? 'success' : 'outline-success'"
            @click="filter = 'collected'"
          >
            おぼえた歌
          </b-button>
          <b-button
            :variant="
              filter === 'uncollected' ? 'secondary' : 'outline-secondary'
            "
            @click="filter = 'uncollected'"
          >
            まだおぼえていない歌
          </b-button>
        </b-button-group>
    ...
    <div class="row">
      ...
      >
        <div
          class="poem-card"
          :class="{
            collected: isCollected(poem.id),
            uncollected: !isCollected(poem.id),
          }"
    ...
    <b-modal
      v-model="showModal"
      :title="selectedPoem ? `第${selectedPoem.id}首` : ''"
      size="lg"
      hide-footer
    >
